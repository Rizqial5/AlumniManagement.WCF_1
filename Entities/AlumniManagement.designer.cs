...
namespace AlumniManagement.WCF.Entities
{
    ...
    partial void InsertAspNetPermission(AspNetPermission instance);
    partial void UpdateAspNetPermission(AspNetPermission instance);
    partial void DeleteAspNetPermission(AspNetPermission instance);
    partial void InsertAspNetRolePermission(AspNetRolePermission instance);
    partial void UpdateAspNetRolePermission(AspNetRolePermission instance);
    partial void DeleteAspNetRolePermission(AspNetRolePermission instance);
    ...
    partial void DeleteAspNetUserRole(AspNetUserRole instance);
		...
		public System.Data.Linq.Table<AspNetPermission> AspNetPermissions
		{
			get
			{
				return this.GetTable<AspNetPermission>();
			}
		}
		
		public System.Data.Linq.Table<AspNetRolePermission> AspNetRolePermissions
		{
			get
			{
				return this.GetTable<AspNetRolePermission>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AspNetPermissions")]
	public partial class AspNetPermission : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AspNetRolePermission> _AspNetRolePermissions;
    ...
    partial void OnNameChanged();
		...
		{
			this._AspNetRolePermissions = new EntitySet<AspNetRolePermission>(new Action<AspNetRolePermission>(this.attach_AspNetRolePermissions), new Action<AspNetRolePermission>(this.detach_AspNetRolePermissions));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetPermission_AspNetRolePermission", Storage="_AspNetRolePermissions", ThisKey="Id", OtherKey="PermissionId")]
		public EntitySet<AspNetRolePermission> AspNetRolePermissions
		{
			get
			{
				return this._AspNetRolePermissions;
			}
			set
			{
				this._AspNetRolePermissions.Assign(value);
			}
		}
		...
		private void attach_AspNetRolePermissions(AspNetRolePermission entity)
		{
			this.SendPropertyChanging();
			entity.AspNetPermission = this;
		}
		
		private void detach_AspNetRolePermissions(AspNetRolePermission entity)
		{
			this.SendPropertyChanging();
			entity.AspNetPermission = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AspNetRolePermissions")]
	public partial class AspNetRolePermission : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<AspNetPermission> _AspNetPermission;
    ...
    partial void OnPermissionIdChanged();
		...
		{
			this._AspNetPermission = default(EntityRef<AspNetPermission>);
		...
		public int PermissionId
		{
			...
			set
			{
				...
				{
					if (this._AspNetPermission.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetPermission_AspNetRolePermission", Storage="_AspNetPermission", ThisKey="PermissionId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public AspNetPermission AspNetPermission
		{
			get
			{
				return this._AspNetPermission.Entity;
			}
			set
			{
				AspNetPermission previousValue = this._AspNetPermission.Entity;
				if (((previousValue != value) 
							|| (this._AspNetPermission.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._AspNetPermission.Entity = null;
						previousValue.AspNetRolePermissions.Remove(this);
					}
					this._AspNetPermission.Entity = value;
					if ((value != null))
					{
						value.AspNetRolePermissions.Add(this);
					...
					this.SendPropertyChanged("AspNetPermission");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetRole_AspNetRolePermission", Storage="_AspNetRole", ThisKey="RoleId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetRole_AspNetRolePermission", Storage="_AspNetRolePermissions", ThisKey="Id", OtherKey="RoleId")]
		public EntitySet<AspNetRolePermission> AspNetRolePermissions
		{
			get
			{
